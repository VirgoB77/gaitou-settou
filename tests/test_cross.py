...
**捕まえないもの。**
  ...
  ・`ratePer1k` 以外の、Python と JS に重ねて書いた判断
    （伏せ字の札、色の階級、横棒の幅）。いまは1本だけ突き合わせている
  ・JS 側にしか無い分岐。Python に相手が無いものは比べようがない
  ・当てている入力の外。件数7 × 人口6 の42通りだけ

**「一致している」と言えるのは、当てた入力についてだけ。**
"""
